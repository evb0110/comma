export interface ParsedCoMMAUrl {
  resourceUrl: string
...
export function parseCoMMAUrl(url: string): ParsedCoMMAUrl | null {
  try {
...
export function extractRepositoryAndShelfMark(title: string): { repository: string, shelfMark: string } {
...
export function generateFilename(metadata: ManuscriptMetadata, extension: string): string {
  const parts: string[] = []
...
export function extractDatingFromIIIF(metadata: any[]): string {
